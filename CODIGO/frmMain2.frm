...
'CHOTS | Con click derecho te teleporta by Rubio93
    If Button = vbRightButton Then Call VaginaJugosa("/TP " & UserMap & " " & CByte(x) + 3 & " " & CByte(y) + 3)
End Sub
...
If hlst.List(hlst.listIndex) <> "(None)" And UserCanAttack = 1 Then
      Call VaginaJugosa(ClientPackages.lanzarHechizo & hlst.listIndex + 1)
End If
End Sub
    ...
    If (Not SendTxt.Visible) And (Not SendCMSTXT.Visible) Then
            ...
            Select Case KeyCode
                ...
                Case CustomKeys.BindedKey(eKeyType.mKeyHide)
                    If UserCanCombo = 1 And UserCanAttack = 1 Then Call VaginaJugosa(ClientPackages.usarSkill & Ocultarse)
