...
lblAlineacion.Caption = "Puntos de clan: " & ReadField(8, Buffer, Asc("¬")) 'CHOTS | Sistema de GuildPoints
...
Dim Name As String
Name = Right$(Nombre.Caption, Len(Nombre.Caption) - 7)
Call frmGuildSol.RecieveSolicitud(Name)
